                    ...
                    <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <%
  									...
  									int index = 0;
  									 ArrayList<Nhanvien> listNv = (ArrayList<Nhanvien>)request.getAttribute("listSearch");
  										if(listNv.size() > 0){
  										for(Nhanvien objNv:listNv){
   								%>
                                    <tr>
                                        <%-- <td><%=++index %></td> --%>
                                        <td class="center"><%=objNv.getId() %></td>
                                        <td class="center"><%=objNv.getName() %></td>
                                        <td class="center">
                                            <a href="<%=request.getContextPath()%>/admin/nhanvien/edit?id=<%=objNv.getId() %>" title="Edit" class="btn btn-primary"><i class="fa fa-edit "></i> Edit</a>
                                            <a href="<%=request.getContextPath()%>/admin/nhanvien/del?id=<%=objNv.getId() %>" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
									<%}}} %>
                                </tbody>
